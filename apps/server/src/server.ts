...
import { RelewiseBacklog } from "./relewise/RelewiseBacklog.ts";
import { relewiseHttpApiLayer } from "./relewise/http.ts";
...
export const makeRoutesLayer = Layer.mergeAll(
  Layer.mergeAll(
    HttpApiBuilder.layer(EnvironmentHttpApi).pipe(
      ...
      Layer.provide(relewiseHttpApiLayer),
  ...
  Layer.provide(RelewiseBacklog.layer),
