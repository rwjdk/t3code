...
const configuredUpstreamCommitHash = process.env.T3CODE_UPSTREAM_COMMIT_HASH?.trim() || "";
...
export default defineConfig(() => {
  return {
    ...
    define: {
      ...
      "import.meta.env.T3CODE_UPSTREAM_COMMIT_HASH": JSON.stringify(configuredUpstreamCommitHash),
    },
    resolve: {
      tsconfigPaths: true,
